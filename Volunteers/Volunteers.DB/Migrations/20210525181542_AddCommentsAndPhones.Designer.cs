...
namespace Volunteers.DB.Migrations
{
    ...
    [Migration("20210525181542_AddCommentsAndPhones")]
    partial class AddCommentsAndPhones
    {
        /// <inheritdoc/>
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrganizationPhoneNumber", b =>
                {
                    b.Property<long>("OrganizationsId")
                        .HasColumnType("bigint");

                    b.Property<long>("PhoneNumbersId")
                        .HasColumnType("bigint");

                    b.HasKey("OrganizationsId", "PhoneNumbersId");

                    b.HasIndex("PhoneNumbersId");

                    b.ToTable("OrganizationPhoneNumber");
                });
            ...
            modelBuilder.Entity("OrganizationPhoneNumber", b =>
                {
                    ...
                    b.HasOne("Volunteers.Entities.PhoneNumber", null)
                        .WithMany()
